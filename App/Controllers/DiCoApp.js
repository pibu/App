angular.module('DiCoApp', ['LoginServices', 'UsAcCoPoGrServices', 'ContentServices', 'UploadServices']).config(function ($routeProvider)
{
    ...
    $routeProvider.when('/Palinsesto/:GroupId', { templateUrl: 'Views/Palinsesto.html', controller: PalinsestoCtrl });
